...
This is a simple contacts app using a drawer-based
layout.

You can add, edit and view the contact in your app and sort it as per categories. 
The left side drawer provides you option to view you contacts as per their category.
